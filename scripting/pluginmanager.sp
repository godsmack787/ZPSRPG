...
{
	name = "Plugin Manager edited AlertMod",
	author = "R-Hehl",
	description = "Plugin Manager edited AlertMod",
...
public Action:Menu_ULPlugins(client)
{
	...
	SetMenuTitle(menu, "Выгрузить плагин:")
...
public Action:Menu_LPlugins(client)
{
	...
	SetMenuTitle(menu, "Загрузить плагин:")
...
public Action:Menu_RLPlugins(client)
{
	...
	SetMenuTitle(menu, "Перазагрузить плагин:")
			...
			maxlength)
{
	...
	{
		Format(buffer, maxlength, "Управление плагинами");
	}
...
public Action:Menu_Plugins(client)
{
	...
	SetMenuTitle(menu, "Плагины:")
	AddMenuItem(menu, "Загрузить", "Загрузить")
	AddMenuItem(menu, "Выгрузить", "Выгрузить")
	AddMenuItem(menu, "Перезагрузить", "Перезагрузить")
	SetMenuExitButton(menu, true)
	DisplayMenu(menu, client, 20)
	return Plugin_Handled
}
